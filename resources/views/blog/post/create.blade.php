                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <input type="text" name="title"  class="form-control p-4" placeholder="title"/>
                                </div>
                            </div>
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <select name="category_id"  class="form-control p-4" placeholder="category Name">
                                        ...
                                        <option value="{{$catego->id}}" class="form-control p-4">{{$catego->name}}</option>
       ...
       <div class="flex justify-center mt-8">
        ...
        <div class="w-full" x-data="alpineMuliSelect({selected:['te_11', 'te_12'], elementId:'multSelect'})">
            ...
            <select class="hidden" id="multSelect" name="tage[]">
                @foreach ($tags as $tag )
                <option value="{{$tag->id}}" data-search="{{$tag->name}}">{{$tag->name}}</option>
                        ...
                        <div class="form-row">
                            <div class="col-md-12">
                                <div>
                                    ...
                                    <x-trix name="meta_description"  styling="overflow-y-scroll h-96"></x-trix>
                                </div>
                                </div>
                            </div>
